...
@RibbonClient(name = "fast-pass-service", configuration = TollClientRoutingConfig.class)
@Controller
public class FastPassController {
    ...
    public String getFastPassCustomerDetailsBackup(@RequestParam String fastpassid, Model m) {
        ...
        FastPassCustomer fake = new FastPassCustomer();
        fake.setFastPassId(fastpassid);
        System.out.println("Fallback operation called!");
        m.addAttribute("customer", fake);
        return "console";
    }
